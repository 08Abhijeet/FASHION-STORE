...
function Navbar({ className }) {
  ...
  return (
    ...
    >
      <nav className="flex items-center rounded-2xl dark:border-white/[0.2] justify-between px-6 py-2 bg-gradient-to-r from-red-100 to-red-200 dark:bg-white">
        <div className="flex items-center space-x-4">
          <img
            src={assets.logging}
            alt="Logo"
            className="w-20 h-19 rounded-lg"
          />
          <Link
            to={"/"}
            className="font-semibold text-xl text-black dark:text-white italic"
          >
           Vesteria fashion
          </Link>
        </div>
