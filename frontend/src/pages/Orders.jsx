...
const Orders = () => {
  ...
  return (
    <div className="border-t pt-16 text-red-950">
      ...
      <div>
        ...
        {orderData.slice(0, 4).map((item, index) => (
          <div
            key={index}
            className="py-4 border-t border-b text-red-950 flex flex-col md:flex-row md:items-center md:justify-between gap-4"
          >
