...
const Product = () => {
  ...
  return productData ? (
    <div className="text-red-950 border-t pt-10 transition-opacity ease-in duration-500 opacity-100 ">
      {/* product data */}
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1">
          ...
          <p className="mt-5  text-red-950 md:w-4/5">
          ...
          <button
            ...
            className="bg-white rounded-full px-8 py-3 text-sm active:bg-gray-700"
          >
            ADD TO CART
          </button>
          <hr className="mt-8 sm:w-4/5" />
          <div className="text-sm text-red-950 mt-5 flex flex-col gap-1 last:">
